...
class Ui_EvaluateWindow(object):
    def setupUi(self, EvaluateWindow):
        ...
        EvaluateWindow.setStyleSheet("background-color: rgb(196, 188, 255);")
        EvaluateWindow.setWindowFlags(QtCore.Qt.WindowCloseButtonHint | QtCore.Qt.WindowMinimizeButtonHint)
    ...
    def retranslateUi(self, EvaluateWindow):
        ...
        conn=None
        try:
            db_file =r'C:\Users\Sayantan\Envs\pyqt\qtdesigns\Internshala\data.db'
