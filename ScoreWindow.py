...
class Ui_ScoreWindow(object):
    def setupUi(self, ScoreWindow):
        ...
        ScoreWindow.setStyleSheet("background-color: rgb(196, 188, 255);")
        ScoreWindow.setWindowFlags(QtCore.Qt.WindowCloseButtonHint | QtCore.Qt.WindowMinimizeButtonHint)
    ...
    def retranslateUi(self, ScoreWindow):
        ...
        ScoreWindow.setWindowTitle(_translate("ScoreWindow", "Score"))
